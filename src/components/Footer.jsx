function Footer() {
    ...
    const sections = [
        ...
        { title: 'Apple', links: ['Sobre a Apple', 'News room', 'Privacidade', 'Carreiras'] },
    ];
    ...
    return (
        <footer className="bg-gray-900 border-t border-gray-800">
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <p className="text-xs text-gray-500 mt-6">Site criado para fins educacionais - Tales Nunes de Siqueira</p>
                </div>
            </div>
