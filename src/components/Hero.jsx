function Hero() {
  return (
    <section className="relative h-screen overflow-hidden bg-black pt-16">
      <div className="absolute top-18 bottom-0 right-0 left-0 z-0">
        <img src="img/hero.jpg" alt="iPhone 17 Hero Image" className=" w-full h-full object-cover opacity-90" />
